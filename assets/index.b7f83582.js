import{j,s as r,C as m,r as g,I as P,L as w,G as W,F as _,a as z,b as F,c as D,d as E,R as O,e as h,B as A,S as T,f as y,g as M,W as N,h as V,i as q}from"./vendor.65bf52f0.js";const H=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))l(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function s(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerpolicy&&(n.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?n.credentials="include":i.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function l(i){if(i.ep)return;i.ep=!0;const n=s(i);fetch(i.href,n)}};H();const Y="modulepreload",p={},K="/rp-react-with-styled-components/",C=function(o,s){return!s||s.length===0?o():Promise.all(s.map(l=>{if(l=`${K}${l}`,l in p)return;p[l]=!0;const i=l.endsWith(".css"),n=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${n}`))return;const a=document.createElement("link");if(a.rel=i?"stylesheet":Y,i||(a.as="script",a.crossOrigin=""),a.href=l,document.head.appendChild(a),i)return new Promise((c,L)=>{a.addEventListener("load",c),a.addEventListener("error",L)})})).then(()=>o())},t=j.exports.jsx,d=j.exports.jsxs,G=j.exports.Fragment,Q=({className:e,children:o})=>t("section",{className:e,children:o}),k=r(Q)`
  margin: 0 auto;
...
`,ee=({className:e,children:o,open:s,handleClose:l})=>{const[i,n]=g.exports.useState(s||!1),a=()=>{n(!1),l&&l()};return g.exports.useEffect(()=>{n(s)},[s]),i?d("div",{className:e,children:[t(P,{className:"close",size:"2.5rem",onClick:a}),o]}):null},te=r(ee)`
  @keyframes fadeIn {
    from {
      opacity: 0;
    }
...
`,ae=[{name:"Facebook",icon:_},{name:"Instagram",icon:z},{name:"YouTube",icon:F},{name:"Twitter",icon:D},{name:"LinkedIn",icon:E}],se=[{title:"Main",links:["Blog","FAQs","Support","About us"]},{title:"Product",links:["Login","Personal","Business","Team"]},{title:"Press",links:["Logos","Events","Stories","Office"]},{title:"Legal",links:["GDPR","Privacy Policy","Terms of Service","Disclaimer"]}],le=m`
  background-color: #071c2f;
  padding: 5rem 1rem;
  ${e=>e.theme.media.md} {
    padding: 5rem;
...
`,ge=r(({className:e})=>t("div",{className:e,children:t(k,{maxWidth:"md",children:d($,{cols:{xs:"1",md:"5"},gap:"5rem",children:[d(S,{gridCol:"1/span 1",children:[d(f,{alignItems:"center",justifyContent:{xs:"center",md:"flex-start"},children:[t(B,{src:"/assets/logo.png",alt:"logo"}),t(I,{to:"/",children:"Delta"})]}),d(fe,{children:["69 Street, Delta Building, ",t("br",{}),"US Road, Los Angeles 123"]}),t($,{cols:"5",children:ae.map(({name:o,icon:s})=>t(me,{children:t(s,{})},o))})]}),t(S,{gridCol:{md:"2/span 4"},children:t($,{cols:{xs:"2",md:"4"},gap:"2rem",children:se.map(o=>d(de,{direction:"column",justifyContent:"space-between",children:[t("h2",{children:o.title}),t(ce,{children:o.links.map(s=>t("li",{children:s},s))})]},o.title))})})]})})}))`
  ${le}
`,R=[{to:"/",hash:"#about",text:"About",id:"about"},{to:"/pricing",hash:"",text:"Pricing",id:"pricing"},{to:"/signup",hash:"",text:"Contact",id:"contact"}],he=r(({className:e})=>{const[o,s]=g.exports.useState(!1),l=()=>s(!1);return t("nav",{className:e,children:d(k,{maxWidth:"md",children:[d(f,{justifyContent:"space-between",alignItems:"center",children:[d(f,{className:"logo",alignItems:"center",children:[t(B,{src:"/assets/logo.png",alt:"logo"}),t(I,{to:"/",children:"Delta"})]}),d(f,{children:[t(ie,{size:"1.5rem",onClick:()=>s(!0)}),R.map(({id:i,text:n,to:a,hash:c})=>d(ne,{children:[!c&&t(w,{to:a,children:n}),c&&t("a",{href:a+c,children:n})]},i))]})]}),t(te,{className:"modal",open:o,handleClose:l,children:t(f,{direction:"column",alignItems:"center",children:R.map(({id:i,text:n,to:a,hash:c})=>d(re,{children:[!c&&t(w,{to:a,onClick:l,children:n}),c&&t("a",{href:a+c,onClick:l,children:n})]},i))})})]})})})`
  ${oe}
`,ye=r(O)`
  svg {
...
`,xe=r(({className:e})=>t(f,{className:e,direction:"column",justifyContent:"center",alignItems:"center",children:t(ye,{type:"bubbles"})}))`
  ...
  width: 100vw;
  background-color: #071c2f;
`,ue=h.lazy(()=>C(()=>import("./ContactPage.aa90ae94.js"),["assets/ContactPage.aa90ae94.js","assets/vendor.65bf52f0.js"])),ve=h.lazy(()=>C(()=>import("./HomePage.c42f2053.js"),["assets/HomePage.c42f2053.js","assets/HomePage.b32ce33a.css","assets/vendor.65bf52f0.js"])),be=h.lazy(()=>C(()=>import("./PricingPage.ac8e0b3a.js"),["assets/PricingPage.ac8e0b3a.js","assets/vendor.65bf52f0.js"])),je=()=>t(G,{children:d(A,{children:[t(he,{}),t(g.exports.Suspense,{fallback:t(xe,{}),children:d(T,{children:[t(y,{exact:!0,path:"/pricing",children:t(be,{})}),t(y,{exact:!0,path:"/signup",children:t(ue,{})}),t(y,{exact:!0,path:"/",children:t(ve,{})}),t(y,{path:"*",children:t(M,{to:"/"})})]})}),t(ge,{})]})}),we={colors:{primary:"rebeccapurple",secondary:"green"},maxWidth:{xs:"900px",md:"1536px",lg:"100%"},media:{xs:"@media screen and (min-width: 0px)",md:"@media screen and (min-width: 900px)",lg:"@media screen and (min-width: 1536px)"}},Ce=N`
