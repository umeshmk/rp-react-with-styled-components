...
`,b=e=>m`
  ...
  `,ee=({className:e,children:o})=>t("div",{className:e,children:o}),S=r(ee)`
  // all media
...
`,I=e=>"/rp-react-with-styled-components/"+e,ie=m`
  padding: 1rem 1.5rem;
  position: absolute;
  width: 100%;
...
`,he=r(({className:e})=>t("div",{className:e,children:t(k,{maxWidth:"md",children:d($,{cols:{xs:"1",md:"5"},gap:"5rem",children:[d(S,{gridCol:"1/span 1",children:[d(f,{alignItems:"center",justifyContent:{xs:"center",md:"flex-start"},children:[t(R,{src:I("assets/logo.png"),alt:"logo"}),t(B,{to:"/",children:"Delta"})]}),d(me,{children:["69 Street, Delta Building, ",t("br",{}),"US Road, Los Angeles 123"]}),t($,{cols:"5",children:ae.map(({name:o,icon:a})=>t(ge,{children:t(a,{})},o))})]}),t(S,{gridCol:{md:"2/span 4"},children:t($,{cols:{xs:"2",md:"4"},gap:"2rem",children:le.map(o=>d(ce,{direction:"column",justifyContent:"space-between",children:[t("h2",{children:o.title}),t(fe,{children:o.links.map(a=>t("li",{children:a},a))})]},o.title))})})]})})}))`
  ${de}
`,L=[{to:"/",hash:"#about",text:"About",id:"about"},{to:"/pricing",hash:"",text:"Pricing",id:"pricing"},{to:"/signup",hash:"",text:"Contact",id:"contact"}],ye=r(({className:e})=>{const[o,a]=g.exports.useState(!1),l=()=>a(!1);return t("nav",{className:e,children:d(k,{maxWidth:"md",children:[d(f,{justifyContent:"space-between",alignItems:"center",children:[d(f,{className:"logo",alignItems:"center",children:[t(R,{src:I("assets/logo.png"),alt:"logo"}),t(B,{to:"/",children:"Delta"})]}),d(f,{children:[t(ne,{size:"1.5rem",onClick:()=>a(!0)}),L.map(({id:i,text:n,to:s,hash:c})=>d(re,{children:[!c&&t(j,{to:s,children:n}),c&&t("a",{href:s+c,children:n})]},i))]})]}),t(oe,{className:"modal",open:o,handleClose:l,children:t(f,{direction:"column",alignItems:"center",children:L.map(({id:i,text:n,to:s,hash:c})=>d(se,{children:[!c&&t(j,{to:s,onClick:l,children:n}),c&&t("a",{href:s+c,onClick:l,children:n})]},i))})})]})})})`
  ${ie}
`,xe=r(A)`
  svg {
...
`,ue=r(({className:e})=>t(f,{className:e,direction:"column",justifyContent:"center",alignItems:"center",children:t(xe,{type:"bubbles"})}))`
  ...
  width: 100vw;
  background-color: #071c2f;
`,ve=h.lazy(()=>C(()=>import("./ContactPage.d1cf1d49.js"),["assets/ContactPage.d1cf1d49.js","assets/vendor.65bf52f0.js"])),be=h.lazy(()=>C(()=>import("./HomePage.4258d898.js"),["assets/HomePage.4258d898.js","assets/HomePage.b32ce33a.css","assets/vendor.65bf52f0.js"])),we=h.lazy(()=>C(()=>import("./PricingPage.4476d820.js"),["assets/PricingPage.4476d820.js","assets/vendor.65bf52f0.js"])),je=()=>t(G,{children:d(T,{basename:"/rp-react-with-styled-components/",children:[t(ye,{}),t(g.exports.Suspense,{fallback:t(ue,{}),children:d(M,{children:[t(y,{exact:!0,path:"/pricing",children:t(we,{})}),t(y,{exact:!0,path:"/signup",children:t(ve,{})}),t(y,{exact:!0,path:"/",children:t(be,{})}),t(y,{path:"*",children:t(N,{to:"/"})})]})}),t(he,{})]})}),Ce={colors:{primary:"rebeccapurple",secondary:"green"},maxWidth:{xs:"900px",md:"1536px",lg:"100%"},media:{xs:"@media screen and (min-width: 0px)",md:"@media screen and (min-width: 900px)",lg:"@media screen and (min-width: 1536px)"}},$e=V`
html{scroll-behavior:smooth}
body {
      /* css */
    font-family: "Roboto";
  }
`;function pe(){return t(G,{children:d(q,{theme:Ce,children:[t($e,{}),t(je,{})]})})}H.render(t(h.StrictMode,{children:t(pe,{})}),document.getElementById("root"));export{Se as B,k as C,f as F,$ as G,ke as I,d as a,G as b,S as c,t as j,Ce as t,I as u};
